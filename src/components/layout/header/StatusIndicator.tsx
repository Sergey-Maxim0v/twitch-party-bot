...
const StatusIndicator: FC<StatusIndicatorProps> = ({
    ...
    return (
        ...
        >
            <div
                className="flex items-center gap-2 px-3 py-1.5 bg-base-300 rounded-lg border border-base-100
                ...
                <div className="flex items-center gap-1.5">
                    <span className={`relative flex h-2 w-2`}>
                        ...
                        <span className={`relative inline-flex rounded-full h-2 w-2 ${badgeColors[badgeType]}`}/>
                    </span>
