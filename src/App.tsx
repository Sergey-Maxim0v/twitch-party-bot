...
//  TODO:
//   - при изменении размера очереди перемещать между текущей и будущей очередью
//   (при увеличении добавляются из будущей, при уменьшении удаляются или переносятся в будущую)
...
//   - сделать вертикальное и горизонтальное сворачивание панелей
//   - написать адаптив под все экраны
